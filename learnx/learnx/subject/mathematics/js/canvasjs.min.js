...
(function() {
    ...
    function Ra(a) {
        if (!Aa) {
            var c = !1,
                b = !1;
            "undefined" === typeof ba.Chart.creditHref ? (a.creditHref = "https://www.elabvine.co.za", a.creditText =
                "https://www.elabvine.co.za") : (c = a.updateOption("creditText"), b = a.updateOption("creditHref"));
    ...
    (function() {
        A.fSDec = function(a) { for (var c = "", b = 0; b < a.length; b++) c += String.fromCharCode(a[b] - 111); return c };
        A.str = {
        ...
        A.pro = { sCH: ba[A.fSDec([178, 215, 208, 225, 227])][A.fSDec([210, 225, 212, 211, 216, 227, 183, 225, 212, 213])] };
        A.fAWm = function(a) {
    ...
    (function() {
        ...
        A.str.ltm = [181, 222, 225, 143, 208, 221, 232, 143, 212, 221, 224, 228, 216, 225, 216, 212,
            226, 143, 210, 222, 221, 227, 208, 210, 227, 143, 226, 208, 219, 212, 226, 175, 210, 208, 221, 229, 208, 226, 217, 226, 157, 210, 222, 220
        ];
        ...
        A.fNg = function(a) {
            if (!Aa) try {
                var c;
                a: {
                    var b = RegExp(A.ckDec(A.str.ckn) +
                            "=.*", "gi"),
                        d = new Date,
                        f = document.cookie.match(b),
                        g = localStorage && localStorage.getItem("lclStg") && JSON.parse(localStorage.getItem("lclStg")).name.match(A.ckDec(A.str.ckn)) ? JSON.parse(localStorage.getItem("lclStg")) : null;
                    if (f && 0 < f.length || g) {
                        var l, b = [],
                            k = [],
                            h = null;
                        ...
                        g && (h = g);
                        l = { ckVal: Number(k[0]), lSVal: h ? Number(h.val) : null };
                        g = null;
                        l && l.ckVal && l.lSVal ? g = Math.min(l.ckVal, l.lSVal) : l && l.ckVal ? g = l.ckVal :
                            l && l.lSVal && (g = l.lSVal);
                        ...
                        h = k.getTime();
                        k.setTime(h + 31536E6);
                        var s = { name: A.ckDec(A.str.ckn), val: (new Date).getTime() };
                        document.cookie = A.ckDec(A.str.ckn) + "=" + (new Date).getTime() + "; " + A.ckDec(A.str.ckve) + k.toUTCString() + "; path=/;";
    ...
    L.prototype.addTo = function(a, c, b, d) {
        ...
        f.hasOwnProperty(a) || f.publicProperties && f.publicProperties.hasOwnProperty(a) && "readWrite" ===
    ...
    B.prototype.attachPlotAreaEventHandlers = function() { this.attachEvent({ context: this, chart: this, mousedown: this._plotAreaMouseDown, mouseup: this._plotAreaMouseUp, mousemove: this._plotAreaMouseMove, cursor: this.zoomEnabled ? "col-resize" : "move", cursor: this.panEnabled ? "move" : "default", capture: !0, bounds: this.plotArea }) };
    B.prototype.categoriseDataSeries = function() {
        for (var a = "", c = 0; c < this.data.length; c++)
            if (a = this.data[c], a.dataPoints && (0 !== a.dataPoints.length && a.visible) && 0 <= B._supportedChartTypes.indexOf(a.type)) {
                for (var b =
                        null, d = !1, f = null, g = !1, l = 0; l < this.plotInfo.plotTypes.length; l++)
    ...
    B.prototype._processMultiseriesPlotUnit = function(a) {
        if (a.dataSeriesIndexes && !(1 > a.dataSeriesIndexes.length))
            for (var c = a.axisY.dataInfo, b = a.axisX.dataInfo, d, f, g = !1, l = 0; l < a.dataSeriesIndexes.length; l++) {
                var k =
                    this.data[a.dataSeriesIndexes[l]],
                    h = 0,
                    m = !1,
                    p = !1,
                    n;
                if ("normal" === k.axisPlacement || "xySwapped" === k.axisPlacement) var e = a.axisX.sessionVariables.newViewportMinimum ? a.axisX.sessionVariables.newViewportMinimum : this.options.axisX && this.options.axisX.viewportMinimum ? this.options.axisX.viewportMinimum : this.options.axisX && this.options.axisX.minimum ? this.options.axisX.minimum : a.axisX.logarithmic ? 0 : -Infinity,
                    q = a.axisX.sessionVariables.newViewportMaximum ? a.axisX.sessionVariables.newViewportMaximum : this.options.axisX &&
        ...
        if (a.dataSeriesIndexes &&
            ...
            for (var c = a.axisY.dataInfo, b = a.axisX.dataInfo, d, f, g = !1, l = [], k = [], h = Infinity, m = -Infinity, p = 0; p < a.dataSeriesIndexes.length; p++) {
                var n = this.data[a.dataSeriesIndexes[p]],
                    ...
                    r = !1,
                    s;
                if ("normal" === n.axisPlacement || "xySwapped" === n.axisPlacement) var w = this.sessionVariables.axisX.newViewportMinimum ? this.sessionVariables.axisX.newViewportMinimum : this.options.axisX && this.options.axisX.viewportMinimum ? this.options.axisX.viewportMinimum : this.options.axisX && this.options.axisX.minimum ?
                ...
                for (e = 0; e < n.dataPoints.length; e++) {
                    "undefined" === typeof n.dataPoints[e].x && (n.dataPoints[e].x = e + (a.axisX.logarithmic ?
                        1 : 0));
                    ...
                    if (0 < e) {
                        ...
                        null !== f && null !== n.dataPoints[e - 1].y && (a.axisY.logarithmic ? 0 < f && (v = f / n.dataPoints[e - 1].y, 1 > v && (v = 1 / v), c.minDiff > v && 1 !== v && (c.minDiff = v)) : (v = f - n.dataPoints[e -
                            1].y, 0 > v && (v *= -1), c.minDiff > v && 0 !== v && (c.minDiff = v)))
                    }
                    if (d < w && !q) null !== n.dataPoints[e].y && (s = d);
                        ...
                        d < b.viewPortMin && (b.viewPortMin = d);
                        d > b.viewPortMax && (b.viewPortMax = d);
                        null === n.dataPoints[e].y ? b.viewPortMin === d && s < d && (b.viewPortMin = s) : (a.yTotals[d] = (a.yTotals[d] ? a.yTotals[d] : 0) + Math.abs(f), 0 <= f ? l[d] ? l[d] += f : (l[d] = f, h = Math.min(f, h)) : k[d] ? k[d] += f : (k[d] = f, m = Math.max(f,
                            m)))
                    }
                }
            ...
            for (e in k) k.hasOwnProperty(e) && !isNaN(e) && (a = k[e], a < c.min && (c.min = a), a > c.max && (c.max = Math.max(a, m)), e < b.viewPortMin || e > b.viewPortMax || (a < c.viewPortMin && (c.viewPortMin = a), a > c.viewPortMax && (c.viewPortMax = Math.max(a,
                m))))
        }
    };
        ...
        if (a.dataSeriesIndexes && !(1 > a.dataSeriesIndexes.length)) {
            for (var c = a.axisY.dataInfo, b = a.axisX.dataInfo, d, f, g = !1, l = !1, k = !1, h = [], m = 0; m < a.dataSeriesIndexes.length; m++) {
                var p = this.data[a.dataSeriesIndexes[m]],
                    ...
                    q = !1,
                    r;
                if ("normal" === p.axisPlacement || "xySwapped" === p.axisPlacement) var s = this.sessionVariables.axisX.newViewportMinimum ? this.sessionVariables.axisX.newViewportMinimum : this.options.axisX && this.options.axisX.viewportMinimum ? this.options.axisX.viewportMinimum :
                ...
                for (n = 0; n < p.dataPoints.length; n++) {
                    ...
                    if (0 < n) {
                        ...
                        y(f) || null === p.dataPoints[n - 1].y || (a.axisY.logarithmic ? 0 < f && (u = f / p.dataPoints[n - 1].y, 1 > u && (u = 1 / u), c.minDiff >
                            u && 1 !== u && (c.minDiff = u)) : (u = f - p.dataPoints[n - 1].y, 0 > u && (u *= -1), c.minDiff > u && 0 !== u && (c.minDiff = u)))
                    }
                    if (d < s && !e) null !== f && (r = d);
                    else {
                        ...
                        if (s = h[r].getTime ? h[r].x.getTime() : h[r].x, !(s < a.axisX.dataInfo.viewPortMin || s > a.axisX.dataInfo.viewPortMax && (!k.connectNullData || !w)))
                            if ("number" !== typeof h[r].y) 0 < r && !w && (k.connectNullData ? b.setLineDash && (0 < u.length && (k.options.nullDataLineDashType ||
                                ...
                                if (0 < h[r].markerSize || 0 < k.markerSize) {
                                    ...
                                    f.push(z);
                                    v = F(v);
                                    t && f.push({ x: s, y: w, ctx: d, type: z.type, size: z.size, color: v, borderColor: v, borderThickness: z.borderThickness })
                    ...
                    for (q = !1; n < p.length; n++)
                        if (e = p[n].x.getTime ? p[n].x.getTime() : p[n].x, !(e < a.axisX.dataInfo.viewPortMin || e > a.axisX.dataInfo.viewPortMax && (!m.connectNullData || !q)))
                            if ("number" !== typeof p[n].y) 0 < n && !q && (m.connectNullData ? b.setLineDash && (0 < u.length && (m.options.nullDataLineDashType || !p[n - 1].lineDashType)) && (u[u.length - 1].newLineDashArray = A,
                                ...
                                }(p[n].indexLabel || m.indexLabel || p[n].indexLabelFormatter || m.indexLabelFormatter) && this._indexLabels.push({ chartType: "splineArea", dataPoint: p[n], dataSeries: m, point: { x: e, y: q }, direction: 0 > p[n].y === a.axisY.reversed ? 1 : -1, color: v });
                                q = !1
                            }
                    c();
                    N.drawMarkers(l)
                        ...
                        if (!(q < a.axisX.dataInfo.viewPortMin || q > a.axisX.dataInfo.viewPortMax && (!x.connectNullData || !W)))
                            if ("number" !== typeof I.y) x.connectNullData ||
                                ...
                                if (0 <= x.dataPointIndexes[q]) {
                                    ...
                                    this._eventManager.objectMap[ea] = { id: ea, objectType: "dataPoint", dataSeriesIndex: z, dataPointIndex: x.dataPointIndexes[q], x1: n, y1: e }
                                }
                                0 <= x.dataPointIndexes[q] && 0 !== I.markerSize && (0 < I.markerSize || 0 < x.markerSize) && (q = x.getMarkerProperties(x.dataPointIndexes[q], n, e, b), f.push(q), markerColor = F(ea), t && f.push({ x: n, y: e, ctx: s, type: q.type, size: q.size, color: markerColor, borderColor: markerColor, borderThickness: q.borderThickness }));
                                (I.indexLabel ||
                        ...
                        if (!(q < a.axisX.dataInfo.viewPortMin || q > a.axisX.dataInfo.viewPortMax &&
                            ...
                            if ("number" !== typeof I.y) x.connectNullData || (W || s) || c(), W = !0;
                                ...
                                if (0 <= x.dataPointIndexes[q]) {
                                    ...
                                    this._eventManager.objectMap[Fa] = { id: Fa, objectType: "dataPoint", dataSeriesIndex: z, dataPointIndex: x.dataPointIndexes[q], x1: n, y1: e }
                                }
    ...
    C.prototype.createLabels = function() {
        ...
        if ("axisX" === this.type && b && !this.logarithmic)
            ...
            for (b = this.intervalStartPosition; b <= f; b = parseFloat((this.logarithmic && this.equidistantInterval ? b * Math.pow(this.logarithmBase,
                    this.interval) : b + this.interval).toFixed(14))) a = this.labelFormatter ? this.labelFormatter({ chart: this.chart, axis: this.options, value: b, label: this.labels[b] ? this.labels[b] : null }) : "axisX" === this.type && this.labels[b] ? this.labels[b] : ca(b, this.valueFormatString, this.chart._cultureInfo), a = new U(this.ctx, {
                x: 0,
                y: 0,
                maxWidth: g,
                maxHeight: l,
