...
<html lang="en">
    ...
    <body id="myPage" data-spy="scroll" data-target=".navbar" data-offset="50">
        ...
        <div id="Selectors" class="container">
            ...
            <h2 class="text-center">Midpoint</h2>
            <div class="well">
                <h4 class="text-center">Find the coordinates of midpoint</h4>
            </div>
            <div class="row">
                ...
                <div class="col-sm-8">
                    <form id="myForm">
                        ...
                        <center><button type="button" class="btn btn-primary" onclick="Algorithm_Midpoint_Coordinates();">Solve</button>| |<button onclick="Reset_Form_One()" type="button" class="btn btn-primary">Reset</button></center>
                    </form>
                </div>
                <div class="col-sm-2"></div>
            </div>
            <div class="well">
                <h4 class="text-center">Find the coordinates of one endpoint</h4>
            </div>
            <div class="row">
                <div class="col-sm-2"></div>
                <div class="col-sm-8">
                    <form id="myForm2">
                        <div class="form-group">
                            <p class="text-info">Midpoint value</p>
                            ...
                            <p class="text-info">Endpoint value</p>
                        ...
                        <center><button type="button" class="btn btn-primary" onclick="Algorithm_Midpoint_First_tab();">Solve</button>| |<button onclick="Reset_Form_Two()" type="button" class="btn btn-primary">Reset</button></center>
                    </form>
                </div>
                <div class="col-sm-2"></div>
            </div>
