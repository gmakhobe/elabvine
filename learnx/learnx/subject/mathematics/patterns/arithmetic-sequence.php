...
<html lang="en">
    ...
    <body id="myPage" data-spy="scroll" data-target=".navbar" data-offset="50">
        ...
        <div id="Selectors" class="container">
            <h2 class="text-center">Arithmetic Sequence</h2>
            <div class="well">
            ...
            <div class="row">
                ...
                <div class="col-sm-8">
                    <form id="myForm">
                        ...
                        <center><button type="button" class="btn btn-primary" onclick="Algorithm_Arithmetic_Sequence_General_Formula();">Solve</button>| |<button onclick="Reset_Form_One()" type="button" class="btn btn-primary">Reset</button></center>
                    </form>
                </div>
                <div class="col-sm-2"></div>
            </div>
            ...
            <div class="row">
                ...
                <div class="col-sm-8">
                    <form id="myForm2">
                        <div class="form-group">
                            <label for="numeric1">Value of a (t<sub>1</sub>):</label>
                            <input type="number" class="form-control" id="numerica1" required>
                            <label for="numeric2">Value of d (common difference):</label>
                        ...
                        <center><button type="button" class="btn btn-primary" onclick="Algorithm_Arithmetic_Sequence_Value_Term()">Solve</button>| |<button onclick="Reset_Form_Two()" type="button" class="btn btn-primary">Reset</button></center>
                    </form>
                </div>
                <div class="col-sm-2"></div>
            </div>
            <div class="well">
                <h4 class="text-center">Find the value of n (number of terms) in the sequence</h4>
            </div>
            <div class="row">
                <div class="col-sm-2"></div>
                <div class="col-sm-8">
                    <form id="myForm3">
                        <div class="form-group">
                            ...
                            <label for="numeric3">Value of Tn (term value):</label>
                        ...
                        <center><button type="button" class="btn btn-primary" onclick="Algorithm_Arithmetic_Sequence_Term_Number()">Solve</button>| |<button onclick="Reset_Form_Three()" type="button" class="btn btn-primary">Reset</button></center>
                    </form>
                </div>
                <div class="col-sm-2"></div>
            </div>
