...
<html lang="en">
    ...
    <body id="myPage" data-spy="scroll" data-target=".navbar" data-offset="50">
        ...
        <div id="Selectors" class="container">
            <h2 class="text-center">Simultaneous Equation</h2>
            <h4 class="text-center">Solve the value of X<br><span class="text-info">Make sure the variables to be solved are x and y</span></h4>
                ...
                <div class="col-sm-8">
                    <form id="myForm">
                        <div class="form-inline">
                            <center>
                                <p class="text-info">Equation 1</p>
                        ...
                        <div class="form-inline">
                            <center>
                                <p class="text-info">Equation 2</p>
                                <input type="text" class="form-control" id="text-3" placeholder="left hand side" required>
                                <label>=</label>
                                <input type="text" class="form-control" id="text-4" placeholder="right hand side" required>
                            </center>
                        </div>
                        <br>
                        <div id="display-1">
                        ...
                        <center><button type="button" class="btn btn-primary" onclick="Algorithm_Algebra_Simultaneous();">Solve</button>| |<button onclick="Reset_Form_One()" type="button" class="btn btn-primary">Reset</button></center>
                    </form>
                </div>
                <div class="col-sm-2"></div>
            </div>
