...
<html lang="en">
    ...
    <body id="myPage" data-spy="scroll" data-target=".navbar" data-offset="50">
        ...
        <div id="Selectors" class="container">
            ...
            <h2 class="text-center">Nominal and effective interest rates</h2>
            <div class="well">
            ...
            <div class="row">
                ...
                <div class="col-sm-8">
                    <form id="myForm">
                        ...
                        <center><button type="button" class="btn btn-primary" onclick="Algorithm_Finance_Effective_Interest();">Solve</button>| |<button onclick="Reset_Form_One()" type="button" class="btn btn-primary">Reset</button></center>
                    </form>
                </div>
                <div class="col-sm-2"></div>
            </div>
