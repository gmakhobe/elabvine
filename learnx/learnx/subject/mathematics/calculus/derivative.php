...
<html lang="en">
    ...
    <body id="myPage" data-spy="scroll" data-target=".navbar" data-offset="50">
        ...
        <div id="Selectors" class="container">
            ...
            <h2 class="text-center">Derivative</h2>
            <div class="well">
                <h4 class="text-center">Find the value of f´(x) from first principle</h4>
            </div>
            <div class="row">
                ...
                <div class="col-sm-8">
                    <form id="myForm">
                        ...
                        <center><button type="button" class="btn btn-primary" onclick="Algorithm_Calculus_Derivative();">Solve</button>| |<button onclick="Reset_Form_One()" type="button" class="btn btn-primary">Reset</button></center>
                    </form>
                </div>
                <div class="col-sm-2"></div>
            </div>
