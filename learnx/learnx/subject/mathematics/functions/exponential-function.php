...
<html lang="en">
    ...
    <body id="myPage" data-spy="scroll" data-target=".navbar" data-offset="50">
        ...
        <div id="Selectors" class="container">
            ...
            <h3 class="text-center">Exponential Function</h3>
            <h4 class="text-center"></h4>
            <div class="row">
                <div class="col-sm-2"></div>
                <div class="col-sm-8">
                    <ul class="nav nav-tabs nav-justified">
                        <li class="active"><a href="#tab-1" data-toggle="tab">Draw Exponential Function Graph and Find Exceptional</a></li>
                        <li><a href="#tab-2" data-toggle="tab">Find The Equation of Exponential Function Graph</a></li>
                    </ul>
                </div>
                <div class="col-sm-2"></div>
            </div>
                        ...
                        <div class="col-sm-8">
                            <form id="myForm">
                                <div class="form-group">
                                    <label for="TextBox-1-of-1">Enter Exponential Functions Equation:</label>
                                ...
                                <center><button type="button" class="btn btn-primary" onclick="Algorithm_Exponential_Function_Graph_Sketch();">Solve</button>| |<button onclick="Reset_Form_One()" type="button" class="btn btn-primary">Reset</button></center>
                            </form>
                        </div>
                        <div class="col-sm-2"></div>
                    </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-8">
                            <form id="myForm2">
                                ...
                                <center><button type="button" class="btn btn-primary" onclick="Algorithm_Exponential_Function_Find_Equation()">Solve</button>| |<button onclick="Reset_Form_Two()" type="button" class="btn btn-primary">Reset</button></center>
                            </form>
                        </div>
                        <div class="col-sm-2"></div>
                    </div>
