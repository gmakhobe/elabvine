...
<body id="myPage" data-spy="scroll" data-target=".navbar" data-offset="50">
    ...
    <div id="Selectors" class="container-fluid">
        <h2 class="text-center">Cosine Function</h2>
                    ...
                    <div class="col-sm-8">
                        <form id="myForm">
                            <div class="form-inline">
                                <label for="TextBox-1-of-1">Enter Cosine Functions Equation:</label>
                                <input type="text" class="form-control" id="TextBox-1-of-1" placeholder="in a form acosb (x + p) + q" required>
                            </div>
                            <br>
                            <div id="display-1">
