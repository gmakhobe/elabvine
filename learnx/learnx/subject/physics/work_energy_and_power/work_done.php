        ...
        <div id="content" class="container text-center">
            ...
            <div class="row">
                ...
                <div class="col-sm-8 col-xs-12">
                    <img src="../images/work-bicycle-ride.gif" style="width:100%;height:350px;">
                </div>
                <div class="col-sm-2 col-xs-12 hidden-xs"></div>
            </div>
            <div id="Carouse-1-of-1" class="carousel slide text-center" data-ride="carousel">
                ...
                <div class="carousel-inner" role="listbox">
                    <div class="item active">
                        <h4>Find value of work done by force<sub>type</sub></h4>
                        ...
                        <div class="modal-body" style="height:50%;">
                            ...
                            <form>
                                <div class="form-group">
                                    <label for="text1">Force<sub>Type</sub></label>
                                    <input class="form-control" id="text1" type="text">
                                    <label for="text2">Gravity</label>
                                    <input class="form-control" id="text2" type="text">
                                    <label for="text1">Displacement</label>
                                    <input class="form-control" id="text3" type="text">
                                    <label for="text2">cos &Theta;</label>
                                    <input class="form-control" id="text4" type="text">
                                </div>
                            </form>
                            <button onclick="wfirst()" class="btn btn-primary" data-dismiss="modal">Solve</button>
                        </div>
