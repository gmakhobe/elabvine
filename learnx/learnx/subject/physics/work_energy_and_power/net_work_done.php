        ...
        <div id="content" class="container text-center">
            ...
            <div class="row">
                ...
                <div class="col-sm-8 col-xs-12">
                    <img src="../images/" alt="No picture which correspond with solver" style="width:100%;height:350px;">
                </div>
                <div class="col-sm-2 col-xs-12 hidden-xs"></div>
            </div>
            <div id="Carouse-1-of-1" class="carousel slide text-center" data-ride="carousel">
                ...
                <div class="carousel-inner" role="listbox">
                    <div class="item active">
                        <h4>Find value of net work done</h4>
                        ...
                        <div class="modal-body" style="height:50%;">
                            ...
                            <form>
                                <div class="form-group">
                                    <label for="text1">First Force<sub>Type</sub></label>
                                    <input class="form-control" id="text1" type="text">
                                    <label for="text2">Second Force<sub>Type</sub></label>
                                    <input class="form-control" id="text2" type="text">
                                    <label for="text3">Displacement</label>
                                    <input class="form-control" id="text3" type="text">
                                    <label for="text4">First cos &Theta;</label>
                                    <input class="form-control" id="text4" type="text">
                                    <label for="text5">Second cos &Theta;</label>
                                    <input class="form-control" id="text5" type="text">
                                </div>
                            </form>
                            <button onclick="wSecond()" class="btn btn-primary" data-dismiss="modal">Solve</button>
                        </div>
