    ...
    <body id="myPage">
        ...
        <div id="content" class="container text-center">
            ...
            <ul class="nav nav-pills nav-justified">
                <li class="active"><a data-toggle="pill" href="#tab-1">&Delta;p = mv<sub>f</sub> &minus; mv<sub>i</sub></a>
                </li>
                <li><a href="#tab-2" data-toggle="pill">&Delta;p = m( v<sub>f</sub> &minus; v<sub>i</sub>)</a></li>
            </ul>
            <div class="tab-content">
                    ...
                    <div id="Carouse-1-of-1" class="carousel slide text-center" data-ride="carousel">
                        ...
                        <div class="carousel-inner" role="listbox">
                            <div class="item active">
                                <h4>Find value value of change in momentum</h4>
                ...
                <div class="tab-pane fade" id="tab-2">
                    ...
                    <div id="Carousel-1-of-2" class="carousel slide text-center" data-ride="carousel">
                        ...
                        <div class="carousel-inner" role="listbox">
                            <div class="item active">
                                <h4>Find value of change in momentum</h4>
                    ...
                    <div class="modal-body" style="height:50%;">
                        ...
                        <form>
                            <div class="form-group">
                                ...
                                <label for="text2">Velocity<sub>Final</sub></label>
                                <input class="form-control" id="text2" type="text">
                                <label for="text3">Second Mass</label>
                                <input class="form-control" id="text3" type="text">
                                <label for="text4">Velocity<sub>Initial</label>
                                <input class="form-control" id="text4" type="text">
                            </div>
                        </form>
                        <button onclick="changeInMomentumTabFirst()" class="btn btn-primary" data-dismiss="modal">Solve</button>
                    </div>
                    ...
                    <div class="modal-body">
                        ...
                        <form>
                            <div class="form-group">
                                ...
                                <label for="textb2">Velocity<sub>Final</sub></label>
                                <input class="form-control" id="textb2" type="text">
                                <label for="textb3">Velocity<sub>Initial</label>
                                <input class="form-control" id="textb3" type="text">
                            </div>
                        </form>
                        <button data-dismiss="modal" onclick="changeInMomentumTabSecond()" class="btn btn-primary btn-default pull-left">Solve </button>
                    </div>
                    <div class="modal-footer">
                        <button type="submit" class="btn btn-default" data-dismiss="modal">
                             Cancel
