        ...
        <div id="content" class="container text-center">
            ...
            <div class="row">
                ...
                <div class="col-sm-8 col-xs-12">
                    <img src="../images/momentumheader.png" style="width:100%;height:350px;">
                </div>
                <div class="col-sm-2 col-xs-12 hidden-xs"></div>
            </div>
                        ...
                        <div class="modal-body" style="height:50%;">
                            ...
                            <form>
                                <div class="form-group">
                                    ...
                                    <label for="text2">Velocity</label>
                                    <input class="form-control" id="text2" type="text">
                                </div>
                            </form>
                            <button onclick="momentumFirst()" class="btn btn-primary" data-dismiss="modal">Solve</button>
                        </div>
                ...
                <div class="modal-dialog">
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            ...
                            <form>
                                <div class="form-group">
                                    <label for="textb1">Momentum</label>
                                    <input class="form-control" id="textb1" type="text">
                                    <label for="textb2">Velocity</label>
                                    <input class="form-control" id="textb2" type="text">
                                </div>
                            </form>
                            <button data-dismiss="modal" onclick="momentumSecond()" class="btn btn-primary btn-default pull-left">Solve </button>
                        </div>
                        <div class="modal-footer">
                            <button type="submit" class="btn btn-default" data-dismiss="modal">
                                 Cancel
                        ...
                        <div class="modal-body">
                            ...
                            <form>
                                <div class="form-group">
                                    ...
                                    <label for="textb2">Mass</label>
                                    <input class="form-control" id="textc2" type="text">
                                </div>
                            </form>
                            <button data-dismiss="modal" onclick="momentumThird()" class="btn btn-primary btn-default pull-left">Solve </button>
                        </div>
                        <div class="modal-footer">
                            <button type="submit" class="btn btn-default" data-dismiss="modal">
                                 Cancel
