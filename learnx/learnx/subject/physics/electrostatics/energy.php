        ...
        <div id="content" class="container text-center">
            ...
            <div class="row">
                ...
                <div class="col-sm-8 col-xs-12">
                    <img src="../images/electrostatics-onecharge.png" style="width:100%;height:350px;">
            ...
            <div id="Carouse-1-of-1" class="carousel slide text-center" data-ride="carousel">
                ...
                <div class="carousel-inner" role="listbox">
                    <div class="item active">
                        <h4>Find value of electrical energy</h4>
                        ...
                        <div class="modal-body" style="height:50%;">
                            ...
                            <form>
                                <div class="form-group">
                                    ...
                                    <label for="text2">Distance</label>
                                    <input class="form-control" id="text2" type="text">
                                </div>
                            </form>
                            <button onclick="eEnergy()" class="btn btn-primary" data-dismiss="modal">Solve</button>
                        </div>
