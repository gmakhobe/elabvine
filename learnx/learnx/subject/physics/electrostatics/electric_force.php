        ...
        <div id="content" class="container text-center">
            ...
            <div class="row">
                ...
                <div class="col-sm-8 col-xs-12">
                    <img src="../images/electrostatics-twospheres.png" style="width:100%;height:350px;">
                        ...
                        <div class="modal-body" style="height:50%;">
                            ...
                            <form>
                                <div class="form-group">
                                    ...
                                    <label for="text3">Distance Between Charges</label>
                                    <input class="form-control" id="text3" type="text">
                                </div>
                            </form>
                            <button onclick="eforceFirst()" class="btn btn-primary" data-dismiss="modal">Solve</button>
                        </div>
              ...
              <div class="modal-dialog">
                <div class="modal-content">
                  ...
                  <div class="modal-body">
                    ...
                    <form>
                      <div class="form-group">
                        <label for="text11">Force<sub>Electric</sub></label>
                        <input class="form-control" id="text111111" type="text">
                        <label for="text22">Distance Between Charges</label>
                        <input class="form-control" id="text225555" type="text">
                      </div>
                    </form>
                    <button data-dismiss="modal" onclick="eforceSecond()" class="btn btn-primary btn-default pull-left">Solve </button>
                  </div>
                  <div class="modal-footer">
                    <button type="submit" class="btn btn-default" data-dismiss="modal">
                       Cancel
                ...
                <div class="modal-dialog">
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            ...
                            <form>
                                <div class="form-group">
                                    <label for="text111">Force<sub>Electric</sub></label>
                                    <input class="form-control" id="text11" type="text">
                                    <label for="text222">First Charge</label>
                                    <input class="form-control" id="text12" type="text">
                                    <label for="text333">Second Charge</label>
                                    <input class="form-control" id="text13" type="text">
                                </div>
                            </form>
                            <button data-dismiss="modal" onclick="eforceSecond()" class="btn btn-primary btn-default pull-left">Solve </button>
                        </div>
