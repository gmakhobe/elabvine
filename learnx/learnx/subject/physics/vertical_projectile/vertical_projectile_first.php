                        ...
                        <div class="modal-body" style="height:50%;">
                            ...
                            <form>
                                <div class="form-group">
                                    ...
                                    <label for="text3">&Delta;Time</label>
                                    <input class="form-control" id="text3" type="text">
                                </div>
                            </form>
                            <button onclick="vfirstFirst()" class="btn btn-primary" data-dismiss="modal">Solve</button>
                        </div>
                        ...
                        <div class="modal-body">
                            ...
                            <form>
                                <div class="form-group">
                                    ...
                                    <label for="textb3">&Delta;Time</label>
                                    <input class="form-control" id="textb3" type="text">
                                </div>
                            </form>
                            <button data-dismiss="modal" onclick="vfirstSecond()" class="btn btn-primary btn-default pull-left">Solve </button>
                        </div>
                        <div class="modal-footer">
                            <button type="submit" class="btn btn-default" data-dismiss="modal">
                                 Cancel
                ...
                <div class="modal-dialog">
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            ...
                            <button data-dismiss="modal" onclick="vfirstThird()" class="btn btn-primary btn-default pull-left">Solve </button>
                        </div>
                        <div class="modal-footer">
                            <button type="submit" class="btn btn-default" data-dismiss="modal">
                                 Cancel
