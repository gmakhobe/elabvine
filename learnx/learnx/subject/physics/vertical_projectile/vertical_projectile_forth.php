                ...
                <div class="modal-dialog">
                    <div class="modal-content">
                        ...
                        <div class="modal-body" style="height:50%;">
                            ...
                            <button onclick="ysecondFirst()" class="btn btn-primary" data-dismiss="modal">Solve</button>
                        </div>
                ...
                <div class="modal-dialog">
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            ...
                            <form>
                                <div class="form-group">
                                    <label for="textb1">&Delta;Displacement</label>
                                    <input class="form-control" id="textb1" type="text">
                                    <label for="textb2">Velocity<sub>Initial</sub></label>
                                    <input class="form-control" id="textb2" type="text">
                                    <label for="textb3">Velocity<sub>Time</sub></label>
                                    <input class="form-control" id="textb3" type="text">
                                </div>
                            </form>
                            <button data-dismiss="modal" onclick="ysecondSecond()" class="btn btn-primary btn-default pull-left">Solve </button>
                        </div>
                        <div class="modal-footer">
                            <button type="submit" class="btn btn-default" data-dismiss="modal">
                                 Cancel
