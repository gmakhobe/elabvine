...
<html lang="en">
    ...
    <head>
        <title>Projectile Motion | Physics Lab</title>
        <!-- Headers -->
        ...
        <div id="content" class="container text-center">
            ...
            <div class="row">
                ...
                <div class="col-sm-8 col-xs-12">
                    <img src="../images/verticalprojectile/headerimage.gif" style="width:100%;height:350px;">
                </div>
                <div class="col-sm-2 col-xs-12 hidden-xs"></div>
            </div>
            <div id="Carouse-1-of-1" class="carousel slide text-center" data-ride="carousel">
                ...
                <div class="carousel-inner" role="listbox">
                    ...
                    <div class="item">
                        <h4>Find value of displacement</h4>
                        ...
                        <div class="modal-body" style="height:50%;">
                            ...
                            <form>
                                <div class="form-group">
                                    <label for="text1">Velocity<sub>Initial</sub></label>
                                    <input class="form-control" id="text1" type="text">
                                    <label for="text2">Acceleration</label>
                                    <input class="form-control" id="text2" type="text">
                                    <label for="text3">&Delta;Displacement</label>
                                    <input class="form-control" id="text3" type="text">
                                </div>
                            </form>
                            <button onclick="vsecondFirst()" class="btn btn-primary" data-dismiss="modal">Solve</button>
                        </div>
                ...
                <div class="modal-dialog">
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            ...
                            <form>
                                <div class="form-group">
                                    <label for="textb1">Velocity<sub>Final</sub></label>
                                    <input class="form-control" id="textb1" type="text">
                                    <label for="textb2">Acceleration</label>
                                    <input class="form-control" id="textb2" type="text">
                                    <label for="textb3">&Delta;Displacement</label>
                                    <input class="form-control" id="textb3" type="text">
                                </div>
                            </form>
                            <button data-dismiss="modal" onclick="vsecondSecond()" class="btn btn-primary btn-default pull-left">Solve </button>
                        </div>
                        <div class="modal-footer">
                            <button type="submit" class="btn btn-default" data-dismiss="modal">
                                 Cancel
                ...
                <div class="modal-dialog">
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            ...
                            <form>
                                <div class="form-group">
                                    <label for="textc1">Velocity<sub>Final</sub></label>
                                    <input class="form-control" id="textc1" type="text">
                                    <label for="textc2">Velocity<sub>Initial</sub></label>
                                    <input class="form-control" id="textc2" type="text">
                                    <label for="textc3">Acceleration</label>
                                    <input class="form-control" id="textc3" type="text">
                                </div>
                            </form>
                            <button data-dismiss="modal" onclick="vsecondThird()" class="btn btn-primary btn-default pull-left">Solve </button>
                        </div>
                        <div class="modal-footer">
                            <button type="submit" class="btn btn-default" data-dismiss="modal">
                                 Cancel
