        ...
        <div id="content" class="container text-center">
            ...
            <div class="row">
                ...
                <div class="col-sm-8 col-xs-12">
                    <img src="../images/gattractionpic.png" style="width:100%;height:350px;">
                    <div class="alert alert-danger">
                        <p class="text-center text-danger"><strong>Tip!</strong> Please Note<br>If you are a given a value in a format like : 1.4 &times; 10<sup>-2</sup> <b>please input it as 1.4e-2</b> because the <b>e</b> act as : <b>&times; 10</b> and <b>-2</b> act as exponent.</p>
                    </div>
                </div>
                <div class="col-sm-2 col-xs-12 hidden-xs"></div>
            </div>
                            ...
                            <div class="modal-body" style="height:50%;">
                                ...
                                <form>
                                    <div class="form-group">
                                        ...
                                        <label for="text3">Distance</label>
                                        <input class="form-control" id="text3" type="text">
                                    </div>
                                </form>
                                <button onclick="gattractionFirst()" class="btn btn-primary" data-dismiss="modal">Solve</button>
                            </div>
                ...
                <div class="modal-dialog">
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            ...
                            <form>
                                <div class="form-group">
                                    <label for="textb1">Force</label>
                                    <input class="form-control" id="textb1" type="text">
                                    <label for="textb2">First Mass</label>
                                    <input class="form-control" id="textb2" type="text">
                                    <label for="textb3">Second Mass</label>
                                    <input class="form-control" id="textb3" type="text">
                                </div>
                            </form>
                            <button data-dismiss="modal" onclick="gattractionSecond()" class="btn btn-primary btn-default pull-left">Solve </button>
                        </div>
                        <div class="modal-footer">
                            <button type="submit" class="btn btn-default" data-dismiss="modal">
                                 Cancel
