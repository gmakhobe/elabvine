    ...
    <body id="myPage">
        ...
        <div id="content" class="container text-center">
            ...
            <ul class="nav nav-pills nav-justified">
                <li class="active"><a data-toggle="pill" href="#tab-1">f<sub>s</sub><sup>max</sup> = u<sub>s</sub> &times; N</a>
                </li>
                <li><a href="#tab-2" data-toggle="pill">f<sub>k</sub><sup>max</sup> = u<sub>k</sub> &times; N</a></li>
            </ul>
            <div class="tab-content">
                <div class="tab-pane active fade in" id="tab-1">
                    <div class="row">
                        ...
                        <div class="col-sm-8 col-xs-12">
                            <img src="../images/friction1.png" style="width:100%;height:350px;">
                        </div>
                        <div class="col-sm-2 col-xs-12 hidden-xs"></div>
                    </div>
                    <div id="Carouse-1-of-1" class="carousel slide text-center" data-ride="carousel">
                        ...
                        <div class="carousel-inner" role="listbox">
                            <div class="item active">
                                <h4>Find the value of static friction</h4>
                ...
                <div class="tab-pane fade" id="tab-2">
                    <div class="row">
                        <div class="col-sm-2 col-xs-12 hidden-xs"></div>
                        <div class="col-sm-8 col-xs-12">
                            <img src="../images/friction2.png" style="width:100%;height:350px;">
                        </div>
                        <div class="col-sm-2 col-xs-12 hidden-xs"></div>
                    </div>
                    <div id="Carousel-1-of-2" class="carousel slide text-center" data-ride="carousel">
                        ...
                        <div class="carousel-inner" role="listbox">
                            <div class="item active">
                                <h4>Find the value of kinetic friction</h4>
                    ...
                    <div class="modal-body" style="height:50%;">
                        ...
                        <form>
                            <div class="form-group">
                                <label for="text1">Coefficient</label>
                                <input class="form-control" id="text1" type="text">
                                <label for="text2">Mass</label>
                                <input class="form-control" id="text2" type="text">
                            </div>
                        </form>
                        <button onclick="frictionTabFirst()" class="btn btn-primary" data-dismiss="modal">Solve</button>
                    </div>
            ...
            <div class="modal-dialog">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        ...
                        <button data-dismiss="modal" onclick="frictionTabSecond()" class="btn btn-primary btn-default pull-left">Solve </button>
                    </div>
                    <div class="modal-footer">
                        <button type="submit" class="btn btn-default" data-dismiss="modal">
                             Cancel
