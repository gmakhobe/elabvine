        ...
        <div id="content" class="container text-center">
            ...
            <div class="row">
                ...
                <div class="col-sm-8 col-xs-12">
                    <img src="../images/approach.png" style="width:100%;height:350px;">
                </div>
                <div class="col-sm-2 col-xs-12 hidden-xs"></div>
            </div>
                ...
                <div class="modal-dialog">
                    <div class="modal-content">
                        ...
                        <div class="modal-body" style="height:50%;">
                            ...
                            <button onclick="dopplerAfirst()" class="btn btn-primary" data-dismiss="modal">Solve</button>
                        </div>
                ...
                <div class="modal-dialog">
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            ...
                            <button data-dismiss="modal" onclick="dopplerAsecond()" class="btn btn-primary btn-default pull-left">Solve </button>
                        </div>
                        <div class="modal-footer">
                            <button type="submit" class="btn btn-default" data-dismiss="modal">
                                 Cancel
                ...
                <div class="modal-dialog">
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            ...
                            <button data-dismiss="modal" onclick="dopplerAthird()" class="btn btn-primary btn-default pull-left">Solve </button>
                        </div>
                        <div class="modal-footer">
                            <button type="submit" class="btn btn-default" data-dismiss="modal">
                                 Cancel
                ...
                <div class="modal-dialog">
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            ...
                            <button data-dismiss="modal" onclick="dopplerAforth()" class="btn btn-primary btn-default pull-left">Solve </button>
                        </div>
                        <div class="modal-footer">
                            <button type="submit" class="btn btn-default" data-dismiss="modal">
                                 Cancel
