...
//Send Email No Credits
function sendMailMessageOnly($emailFrom, $subject, $message) {
    //Send Email To Elabvine
    $to = 'givenmakhobela@elabvine.com';
    $email = $emailFrom;
    $subject = $subject;
    $text = $message;
...
//Send Email No Credits
function sendMailMessageToUser($toUser, $emailFrom, $subjectUser, $message) {
    //Send Email To Elabvine
    $to = $toUser;
    $email = $emailFrom;
    $subject = $subjectUser;
