...
if (isset($_REQUEST["reqId"])) {
    ...
    if ($_REQUEST["reqId"] == "lessonFullDetails") {
        $display = "includes/completed-lessons-details.php";
    } else if ($_REQUEST["reqId"] == "lessonBlocked") {
        $display = "includes/blocked-lessons-details.php";
    } else if ($_REQUEST["reqId"] == "profileTutor") {
        $display = "includes/tutor-application-profile.php";
    }
} else {
    $display = "includes/completed-lessons.php";
}
?>
<!doctype html>
