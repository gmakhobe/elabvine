...
?>
<a href="users-one.php" class="btn btn-outline-primary btn-lg btn-block">Back To Tutors Main View</a>

<hr>
<div class="col-lg-12 col-md-12">
<div class="btn-group btn-block">
    <button onclick="ApproveTutoringProfile(<?php echo $userId;?>)" class="btn btn-success">Accepted Application</button>
    <button onclick="UnpublishTutoringProfile(<?php echo $userId;?>)" class="btn btn-warning">Reject Application</button>
