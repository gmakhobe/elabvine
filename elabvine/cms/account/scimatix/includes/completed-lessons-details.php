...
<hr>
<h4>This lesson is complete!</h4><br>
<div class="alert alert-info fade in alert-dismissible show">
    <button type="button" class="close" data-dismiss="alert" aria-label="Close">
        <span aria-hidden="true" style="font-size:20px">×</span>
    </button>    <strong>Alert!</strong> This lesson is complete.
</div>
<hr>
    ...
    <div class="card">
        ...
        <div class="card-footer">
            ...
            <ul class="nav nav-tabs">
                ...
                <li class="nav-item">
                    <a class="nav-link" data-toggle="tab" href="#menu1">Tutor Rating</a>
                </li>
            </ul>
                        ...
                        <table class="table">
                            ...
                            <tbody>
                                <tr>
                                    <th scope="row">1</th>
                                    <td>Stars</td>
                                    <td><?php echo $ratingStars;?></td>
                                </tr>
                                <tr>
                                    <th scope="row">2</th>
                                    <td>Subject</td>
                                    <td><?php echo $ratingTitle;?></td>
                                </tr>
                                <tr>
                                    <th scope="row">2</th>
                                    <td>Comment</td>
                                    <td><?php echo $ratingComment;?></td>
                                </tr>
                                <tr>
                                    <th scope="row">3</th>
                                    <td>Notes</td>
                                    <td><?php echo $ratingNotes;?></td>
                                </tr>
                            </tbody>
                        </table>
