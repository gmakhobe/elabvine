...
<div class="col-lg-12 col-md-12">
    <div class="card">
        ...
        <div class="card-body">
            ...
            <hr>
            <div class="mx-auto d-block">
                <center><button type="button" class="btn btn-outline-dark" data-toggle="modal" data-target="#tutorListModal">Click To Assign A Tutor!</button></center>
                <h5 class="text-sm-center mt-2 mb-1">No Tutor</h5>
            </div>
