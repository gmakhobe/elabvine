    ...
    <body>
                            ...
                            <div class="col-lg-12 p-slide">
                                <article class="card">
                                    <div class="card-body p-5">
                                        ...
                                        <form role="form" action="https://sandbox.payfast.co.za/eng/process" method="POST">
                                            <div>

                                                <input type="hidden" id="payfast1" name="merchant_id" value="10010379">
                                                <input type="hidden" id="payfast2" name="merchant_key" value="bfmm4g8zaz2up">
                                            ...
                                            <input type="hidden" id="payfast10" name="payment_method" value="eft">
        ...
        <script  type="text/javascript">
            ...
            function selectPackage() {
                ...
                uri = "merchant_id=10010379&merchant_key=bfmm4g8zaz2up&return_url=https://www.elabvine.com/success&cancel_url=https://www.elabvine.com/cancel&notify_url=https://www.elabvine.com/notify&name_first=" + companyuri + "&email_address=" + emailaddress + "&amount=" + total + "&item_name=Subscription Service Fee&payment_method=eft";
