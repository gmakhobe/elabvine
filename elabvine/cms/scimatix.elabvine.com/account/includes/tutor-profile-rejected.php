<div class="alert alert-warning tutor-profile text-center">
    <h1>Application Rejected</h1>
    <p>
        Hi, <?php echo $name; ?> your application to be a tutor was rejected. See message below from Admin.
        <br>
        <?php echo $message; ?>
    </p>
    <button class="primary-btn wh" onclick="tutorProfileQuestionsSlide.next()">Reapply</button>								
</div>
